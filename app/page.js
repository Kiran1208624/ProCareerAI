      ...
      <div className="glass-strong border-b border-white/5">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" className="hidden md:inline-flex text-white/80 hover:text-white hover:bg-white/5">Log in</Button>
            <a href="#workspace">
              <Button className="bg-white text-black hover:bg-white/90 rounded-full font-medium">Get Started <ArrowRight className="w-4 h-4 ml-1" /></Button>
            </a>
